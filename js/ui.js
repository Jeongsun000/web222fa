...
function toggleLoading(isLoading) {
  ...
  let searchIconTxt = document.getElementById("search_icon");
  searchIconTxt.innerHTML = "";
  ...
  if (isLoading) {
    ...
    value = document.createTextNode(" Loading...");
    searchButton.disabled = true;
  } else {
    icon.className = "fas fa-search";
    value = document.createTextNode(" Search");
    searchButton.disabled = false;
  }

  searchIconTxt.append(icon);
  searchIconTxt.append(value);
}
